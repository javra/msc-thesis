...
By using double curly brackets \leani{⦃...⦄} instead of single curly brackets,
...
%be accessible after closing the scope. %TODO
Besides \leani{variables}, there are \linebreak \leani{parameters} which will not be generalized
...
The user can declare a proof in tactic mode with \leani{begin ... end}.
...
\item Using \leani{assert} lets the user prove a named hypothesis which then is added
...
reasons), \leani{do} is the tactic of choice.
...
theories which are used in built-in features like \leani{rewrite}.
...
Here, we define equality \leani{eq} as inductive family of types and, with \leani{idp},
...
\textbf{Univalence} then states that the function \leani{equiv_of_eq}, which lets
...
This inverse \leani{ua} is also the only common form in which univalence appears
elsewhere.
\begin{leancodebr}
section
  universe variable l
...
\section{Category Theory in Lean} \label{section:categories-lean}
...
By doing so, we will be able to write \leani{F a} for its evaluation at an object
\leani{a} and \leani{F f} for its evaluation at a morphism \leani{f}.
\begin{leancode}
...
as extending two worm precategories on the same object type \leani{D₀}, the same 1-skeleton
\leani{C} and dependent types of two-cells that differ by \emph{transposition}
...
In contrast, proving the S-law (\ref{thm:s-law}) takes a surprising amount of effort.
...
To prove the transport laws, we use a similar auxiliary lemma and the
...
The parameters of such a theorem \leani{dbl_functor.congr'} are the following.
(\leani{apD011} is the lemma that equates $f(a,b)$ and $f(a',b')$ for an
...
\end{leancodebr}
The two calls to \leani{apply respect_id₁'} are the use of the fact that each of the
...
Then we turn the regular transports into instances of this new definition using
\leani{transport_} \leani{eq_transport4} and \leani{transport4_transport_acc} so that in the
...
\draw (0,2) -- (1,1) edge[in=90,out=135,loop] (1,1) -- (2,0);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,0) {};
...
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (3,-2) {$\overset{\text{\leani{cases w}}}{\leadsto}$};
\begin{scope}[shift={(4,-3)}]
\draw (0,2) -- (2,2); \draw (1,1) -- (2,1);
\draw (1,2) -- (1,1); \draw (2,2) -- (2,0);
\draw (0,2) --  (1,1) edge[red, line width=3pt] (2,0);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,0) {};
...
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (7,-2) {$\overset{\text{\leani{cases f₂₁}}}{\leadsto}$};
\begin{scope}[shift={(8,-3)}]
\draw (0,2) -- (2,2); \draw (1,1) edge[bend left] (2,1);
\draw (1,2) -- (1,1); \draw (2,2) -- (2,1);
\draw (0,2) --  (1,1) edge[red, bend right, line width=3pt] (2,1);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (-1,-4.5) {$\overset{\text{\leani{cases g₁₂}}}{\leadsto}$};
\begin{scope}[shift={(0,-6)}]
\draw (0,2) -- (2,2);
\draw (1,2) -- (1,1) edge[in=45,out=90,loop] (1,1); \draw (0,2) -- (1,1) -- (2,2);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (3,-4.5) {$\overset{\text{\leani{cases x}}}{\leadsto}$};
\begin{scope}[shift={(4,-6)}]
\draw (0,2) -- (2,2);
\draw (1,2) -- (1,1) -- (2,2); \draw (0,2) edge[red, line width=3pt] (1,1);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (7,-4.5) {$\overset{\text{\leani{cases g₀₀}}}{\leadsto}$};
\begin{scope}[shift={(7.5,-6)}]
\draw (1,1) -- (2,2) -- (1,2) edge[bend right] (1,1);
\draw (1,1) edge[bend right, red, line width=3pt] (1,2);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,1) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,2) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (2,2) {};
\end{scope}
\node at (-1,-6) {$\overset{\text{\leani{cases g₀₁}}}{\leadsto}$};
\begin{scope}[shift={(0.5,-6)}]
\draw (0,0) edge[loop left] (0,0)
			edge[bend left] (1,0)
			edge[bend right] (1,0);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,0) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,0) {};
\end{scope}
\node at (3,-6) {$\overset{\text{\leani{cases u}}}{\leadsto}$};
\begin{scope}[shift={(4.5,-6)}]
\draw (0,0) edge[bend left] (1,0)
			edge[red, line width=3pt, bend right] (1,0);
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (0,0) {};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (1,0) {};
\end{scope}
\node at (7,-6) {$\overset{\text{\leani{cases g₀₂}}}{\leadsto}$};
\node [fill,circle,inner sep=0pt,minimum size=5pt] at (9,-6) {};
\draw (9,-6) edge[loop above] (9,-6);
\end{tikzpicture}
