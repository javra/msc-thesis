...
We start by extending the idea of the set of loops based in a point by allowing
...
Just like for a double groupoid we give faces, degeneracies, compositions
