...
\begin{center}
\begin{tikzpicture}
\fill[fill=white,draw=black,scale=2,label={f1}] (0,0) -- (30:1) -- (0,1) -- (0,0);
\fill[fill=white,draw=black,scale=2] (0,0) -- (0,1) -- (150:1);
\fill[fill=white,draw=black,scale=2] (0,0) -- (0,-1) -- (210:1) --(150:1)--(0,0);
\fill[fill=white,draw=black,scale=2] (0,0) -- (30:1) -- (-30:1) --(0,-1)--(0,0);
\node at (-.85,-.5) {$H$};
\node at (.85,-.5) {$H_i$};
\node at (-.6,.85) {$H_h$};
