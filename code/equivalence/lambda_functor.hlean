...
namespace lambda
  ...
  check @xmod_morphism_hom_family_id
  protected definition functor_on_hom (X Y : Xmod) (f : xmod_morphism X Y) :
...
exit
  ...
  begin
    fapply functor.mk,
      ...
      intros (X, Y, f), cases f with (F, ψ, f3, f4, f5),
        fapply dbl_functor.mk, exact F,
          intros (a, b, c, d, f, g, h, i),
          esimp{lambda.on_objects, lambda.dbl_gpd}, intro m, cases m with (m1, m2),
          fapply lambda_morphism.mk, apply (ψ d m1),
          ...
          intros, exact sorry,
          intros, exact sorry,
       intro X, exact sorry, --functor preserves id
    intros (X, Y, Z, g, f), exact sorry, -/--functor preserves comp
  end
