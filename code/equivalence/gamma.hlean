...
namespace gamma
  ...
  begin
    ...
    fapply (M_morphism.congr),
      apply (transport _ ((@iso_of_id' D₀ D₀set C D₂ G y)⁻¹)),
  ...
  protected definition phi_respect_P_comp_aux7 ⦃x y z : D₀⦄ (a : hom x y) (b : hom y z)
    (lid : hom x x) (filler : D₂ lid id id id) :=
  phi_respect_P_comp_aux6 a b _ _ _ _
  ...
  begin
    ...
    apply concat, rotate 3, apply phi_respect_P_comp_aux7,
    apply moveL_transport_V, apply moveL_transport_V,
    apply concat,
    ...
    apply concat, apply transport4_transport_acc,
    apply concat, apply transport4_transport_acc,
    assert (Pzz : is_hset (hom z z)), apply homH,
